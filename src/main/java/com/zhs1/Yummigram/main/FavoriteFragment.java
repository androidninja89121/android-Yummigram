...
import com.zhs1.Yummigram.adapter.FavoriteGridAdapter;
...
public class FavoriteFragment extends Fragment implements OnClickListener {
    ...
    FavoriteGridAdapter adapterGrid;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,	Bundle savedInstanceState)
	{
        ...
        scrollView = (ScrollView)v.findViewById(R.id.scrollViewFavorite);
        lyContent = (LinearLayout)v.findViewById(R.id.lyContentFavorite);
        gridView = (GridViewWithHeaderAndFooter)v.findViewById(R.id.gridViewFavorite);
        ...
        adapterGrid = new FavoriteGridAdapter(getActivity());
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                WallImage wallImage = DataStore.getInstance().wallImagesForFavorites.get(position);
        ...
        imgvSpinner = (ImageView)v.findViewById(R.id.imgvSpinnerFavorite);
    ...
    public void loadData(){
        ...
        DataStore.getInstance().wallImagesForFavorites.clear();
        ...
        Collections.sort(DataStore.getInstance().wallImagesForFavorites, new Commons.CreatedDateComparator());
    ...
    public void loadNextData(){
        ...
        Commons.getWallImagesForFavorite(FavoriteFragment.this, nLimit);
    }
    ...
    public void presentData(){
        ...
        for(int i = 0; i < DataStore.getInstance().wallImagesForFavorites.size(); i ++){
            if(i > 0){
            ...
            final WallImage wallImage = DataStore.getInstance().wallImagesForFavorites.get(i);
