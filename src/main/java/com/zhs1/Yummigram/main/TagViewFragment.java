 ...
 */
public class TagViewFragment extends Fragment implements View.OnClickListener{
    String strTag;
    ScrollView scrollView;
    LinearLayout lyContent;
    GridViewWithHeaderAndFooter gridView;
    boolean isGridGettingMore = false, isListGettingMore = false, isGridView = true;
    TagViewGridAdapter adapterGrid;
    ImageView imgvGridViewForGrid, imgvListViewForGrid, imgvGridViewForList, imgvListViewForList, imgvSpinner;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,	Bundle savedInstanceState)
    {
        View v = inflater.inflate(R.layout.fragment_tag_view, null);

        this.strTag = getArguments().getString(Constants.eKeyTagKey);

        Global.lastImageUpdateForTag = Calendar.getInstance().getTime();

        DataStore.getInstance().wallImagesForTag.clear();

        Commons.getWallImageForTag(TagViewFragment.this, strTag, Constants.LIMIT_NUMBER_GRID);

        scrollView = (ScrollView)v.findViewById(R.id.scrollViewTagView);
        lyContent = (LinearLayout)v.findViewById(R.id.lyContentTagView);
        gridView = (GridViewWithHeaderAndFooter)v.findViewById(R.id.gridViewTagView);
        ...
        adapterGrid = new TagViewGridAdapter(getActivity());
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                WallImage wallImage = DataStore.getInstance().wallImagesForTag.get(position);
        ...
        imgvSpinner = (ImageView)v.findViewById(R.id.imgvSpinnerTagView);
    ...
    public void loadNextData(){
        ...
        Commons.getWallImageForTag(TagViewFragment.this, strTag, nLimit);
    }

    public void didGetWallImageForTag(){
        if(isGridView){
    ...
    public void presentData(){
        ...
        for(int i = 0; i < DataStore.getInstance().wallImagesForTag.size(); i ++){
            if(i > 0){
            ...
            final WallImage wallImage = DataStore.getInstance().wallImagesForTag.get(i);
