...
/**
 * Created by I54460 on 7/7/2015.
 */
public class SearchViewGridAdapter extends BaseAdapter {
    private Context mContext;

    public SearchViewGridAdapter(Context c){
        mContext = c;
    }

    @Override
    public int getCount() {
        return DataStore.getInstance().wallImagesForSearch.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final WallImage wallImage = DataStore.getInstance().wallImagesForSearch.get(position);
