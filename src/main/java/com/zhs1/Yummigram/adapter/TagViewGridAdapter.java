 ...
 */
public class TagViewGridAdapter extends BaseAdapter {
    private Context mContext;

    public TagViewGridAdapter(Context c){
        mContext = c;
    }

    @Override
    public int getCount() {
        return DataStore.getInstance().wallImagesForTag.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final WallImage wallImage = DataStore.getInstance().wallImagesForTag.get(position);
