...
public class RecipeGridAdapter extends BaseAdapter {
    ...
    public RecipeGridAdapter(Context c){
        mContext = c;
    }

    @Override
    public int getCount() {
        return ((MainActivity)mContext).fragmentRecipe.arrData.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final WallImage wallImage = ((MainActivity)mContext).fragmentRecipe.arrData.get(position);
